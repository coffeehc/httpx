...
//
//var (
//	Transport_Stream Render = transport_stream
//	Transport_Binary Render = transport_binary
//	Transport_Html Render = transport_html
//	Transport_Json Render = transport_json
//	Transport_Jsonp Render = transport_jsonp
//	Transport_Text Render = transport_text
//	Transport_Xml Render = transport_xml
//	Transport_Extend Render = transport_extend
//)
//
//var Error_TransportType = HTTPERR_500("transport's interface type error")
//
//type Render func( v interface{}) error
//
